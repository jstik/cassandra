package com.jstik.fancy.account.storage.dao.repository.cassandra.tag;

import com.jstik.fancy.account.storage.entity.cassandra.tag.EntityByTag;
import com.jstik.fancy.account.storage.entity.cassandra.tag.EntityByTag.UserByTagPrimaryKey;
